<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="detailsList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="cover_pic" align="center" prop="coverPic" width="100">
        <template slot-scope="scope">
          <image-preview :src="scope.row.coverPic" :width="50" :height="50"/>
        </template>
      </el-table-column>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        coverPic: [
          { required: true, message: "cover_pic不能为空", trigger: "blur" }
        ]
      }
    };
  },
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除details编号为"' + ids + '"的数据项？').then(function() {
