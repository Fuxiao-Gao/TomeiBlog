  ...
  <div class="app-container">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="follower_id" prop="followerId">
          <el-input v-model="form.followerId" placeholder="请输入follower_id" />
        </el-form-item>
        <el-form-item label="followee_id" prop="followeeId">
          <el-input v-model="form.followeeId" placeholder="请输入followee_id" />
        </el-form-item>
      </el-form>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        followerId: [
          { required: true, message: "follower_id不能为空", trigger: "blur" }
        ],
        followeeId: [
