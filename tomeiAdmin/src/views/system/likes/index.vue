  ...
  <div class="app-container">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="comment_id" prop="commentId">
          <el-input v-model="form.commentId" placeholder="请输入comment_id" />
        </el-form-item>
      </el-form>
...
<script>
import { listLikes, getLikes, delLikes, addLikes, updateLikes } from "@/api/system/likes";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('system/likes/export', {
        ...this.queryParams
